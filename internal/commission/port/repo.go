...
type TradeEventRepo interface {
	...
	GetPartnerTotalVolume(partnerID string, startedAt time.Time, endedAt time.Time) (float64, error)
	GetPartnerActiveClients(partnerID string, startedAt time.Time, endedAt time.Time) (int64, error)
