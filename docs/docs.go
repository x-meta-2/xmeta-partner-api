...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/structs.SubAffiliateInviteParams"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "body": {
                                            "$ref": "#/definitions/database.SubAffiliateInvite"
                                        }
                                    }
                                }
                            ]
        ...
        "/partner/sub-affiliates/invite/{code}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/structs.SubAffiliateListParams"
                        }
                    }
                ],
                "responses": {
        ...
        "/partner/sub-affiliates/stats": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Stats filters",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/structs.SubAffiliateStatsParams"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "structs.SubAffiliateInviteParams": {
            "type": "object",
            "required": [
                "email"
            ],
        ...
        "structs.SubAffiliateListParams": {
            "type": "object",
            "properties": {
                "current": {
                    "type": "integer"
        ...
        "structs.SubAffiliateStatsParams": {
            "type": "object",
            "properties": {
                "current": {
                    "type": "integer"
